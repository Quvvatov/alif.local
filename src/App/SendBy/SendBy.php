<?php
    ...
    class SendBy {
        ...
        public static function mail($to, $name, $product, $price){
            ...
            $headers = 'From: Вася Пупкин <mymail@site.local>\r\n';
        ...
        // Албатта дар холат кор намекунад, чунки API ключ даркор, регистрация куни, боевой серверда мони бад кор карданаш мумкин
